...
o:value("tunnel", "Tunnel") -- Key and value pairs
o:value("transport", "Transport")
o.default = "tunnel"

tunnel = m:section(NamedSection, "TUNNEL")
x = tunnel:option(ListValue, "hw_offload", translate"HW Offload")
x:value("packet", "Packet")
x:value("no", "No")

transport = m:section(NamedSection, "TRANSPORT")
x = transport:option(ListValue, "hw_offload", translate"HW Offload")
x:value("packet", "Packet")
x:value("no", "No")

o=tunnel:option(DynamicList, "local_subnet", translate("Local Group Subnet"))
o.rmempty= false
o.datatype = 'ip4addr'
...
tunnel = m:section(NamedSection, "TUNNEL")
o=tunnel:option(DynamicList, "remote_subnet", translate("Remote Group Subnet"))
o.rmempty= false
o.datatype = 'ip4addr'
...
tunnel = m:section(NamedSection, "TUNNEL")
x = tunnel:option(ListValue, "startaction",translate"Auto Mode")
x:value("none", "None")
x:value("start", "Start")
x:value("trap", "Trap")
...
transport = m:section(NamedSection, "TRANSPORT")
x = transport:option(ListValue, "startaction",translate"Auto Mode")
x:value("none", "None")
x:value("start", "Start")
x:value("trap", "Trap")

d = transport:option(ListValue, "keyexchange",translate"Key Exchange")
d:value("ikev2", "ikev2")
d.default = "ikev2"

c = transport:option(Value, "ikelifetime",translate"IKE Lifetime")
c.default = "10800"

e = transport:option(Value, "lifetime",translate"Key Lifetime")
e.default = "3600"
